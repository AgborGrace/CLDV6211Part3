...
--Question 3 step 1: Create EventType Table
...
CREATE TABLE Event (
	...
	FOREIGN KEY (EventTypeID) REFERENCES EventType(EventTypeID) ON DELETE SET NULL  --Step 3 B
);
...
-- Queston 3 step 2: seed the EventType Table
...
INSERT INTO Event (EventName, EventDate, Description, VenueID , EventTypeID) --STEP 3 C
VALUES 
